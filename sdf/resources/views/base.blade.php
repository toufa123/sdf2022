                ...
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        ...
                        @if (Route::has('login'))
                                ...
                                @else
                                    <a class="nav-link white dropdown-toggle waves-effect waves-light" href="{{ route('login') }}" role="button" >
                                        <i class="mdi mdi-login-variant"></i>
                                    </a>
                                @if (Route::has('register'))
                                    <a class="nav-link dropdown-toggle waves-effect waves-light" href="{{ route('register') }}" role="button" >
                                        <i class="mdi mdi-account-plus"></i>
                                    </a>
                                    @endif
                                @endauth
    ...
    <div class="content-page">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        2021 - 2023 &copy; <a href="https://spa-rac.org" target="_blank">UNEP-MAP-SPA/RAC</a> | <a href="#">Terms of use</a> | <a href="#">Privacy policy</a> | <a href="#">Disclaimer</a>
                    </div>
